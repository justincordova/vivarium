...
function defaultTunables(): Tunables {
  return {
    ...
    REPRO_SOFT_FRAC: C.REPRO_SOFT_FRAC,
    REPRO_CROWD_LIMIT: C.REPRO_CROWD_LIMIT,
    ALLEE_POP_THRESHOLD: C.ALLEE_POP_THRESHOLD,
    ...
    NEST_THRESHOLD: C.NEST_THRESHOLD,
    // nests (Society, Phase 7A)
    NEST_MAX_STRENGTH: C.NEST_MAX_STRENGTH,
    NEST_DECAY: C.NEST_DECAY,
    NEST_REINFORCE: C.NEST_REINFORCE,
    NEST_COST: C.NEST_COST,
    NEST_CLAIM_RADIUS: C.NEST_CLAIM_RADIUS,
    NEST_SHELTER_METAB_MULT: C.NEST_SHELTER_METAB_MULT,
    NEST_CAP: C.NEST_CAP,
    ...
    TEMP_MIN: C.TEMP_MIN,
    TEMP_MAX: C.TEMP_MAX,
    TEMP_BASELINE: C.TEMP_BASELINE,
    TEMP_SEASON_AMPLITUDE: C.TEMP_SEASON_AMPLITUDE,
    TEMP_NIGHT_DROP: C.TEMP_NIGHT_DROP,
    TEMP_COMFORT: C.TEMP_COMFORT,
    TEMP_COLD_COEF: C.TEMP_COLD_COEF,
